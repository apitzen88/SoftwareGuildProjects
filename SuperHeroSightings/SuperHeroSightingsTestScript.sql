...
insert into Organization (OrganizationID, OrganizationName, Description, Contact, LocationID)
values
(1,'Justice League','A league for justice','Knock twice and ring the doorbell',1),
(2,'Bro Force','A force of bros','just scream really loud',2);
